...
/*   Updated: 2025/02/15 03:52:55 by eel-brah         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void draw_line_1(t_delta delta, t_line line, t_vars *vars, unsigned int color) {
  int i;
...
void draw_line_2(t_delta delta, t_line line, t_vars *vars, unsigned int color) {
  int i;
